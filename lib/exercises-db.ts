...
const CHEST: ExerciseEntry[] = [
  ...
  },
  {
    name: 'Cable Fly',
    slug: 'cable_fly',
    aliases: ['cable flye', 'cable flyes', 'cable flies', 'cable chest fly', 'low cable fly', 'high cable fly', 'cable crossover', 'chest cable fly', 'pec fly cable', 'cable fly crossover', 'cable fly crossovers', 'crossover fly', 'low cable fly crossover', 'low cable fly crossovers', 'low crossover fly'],
    primary: ['chest'],
    secondary: [],
    equipment: ['cables'],
    type: 'weight_reps',
  ...
  },
  {
    name: 'Push-Up',
    slug: 'push_up',
    aliases: ['pushup', 'push up', 'press up', 'pressup', 'standard push up', 'push ups', 'pushups', 'push ups (bodyweight)', 'push up bodyweight', 'bodyweight push up'],
    primary: ['chest'],
    secondary: ['triceps', 'shoulders'],
  ...
  },
  {
    name: 'Pec Deck',
    slug: 'pec_deck',
    aliases: ['pec fly machine', 'machine fly', 'butterfly machine', 'chest machine fly', 'pec dec', 'pek deck', 'peck deck', 'chest butterfly', 'butterfly pec deck', 'butterfly', 'buterfly', 'buterfly pec deck'],
    primary: ['chest'],
    secondary: [],
    equipment: ['machine'],
    type: 'weight_reps',
...
const BACK: ExerciseEntry[] = [
  ...
  },
  {
    ...
    slug: 'seated_cable_row_v_grip',
    aliases: ['v grip cable row', 'v bar cable row', 'v handle seated row', 'close grip seated cable row', 'neutral grip cable row'],
    primary: ['back'],
    secondary: ['biceps'],
    equipment: ['cables'],
    type: 'weight_reps',
  ...
  },
  {
    ...
    aliases: ['straight arm lat pulldown', 'cable pullover', 'stiff arm pulldown', 'lat pushdown', 'straight arm cable pulldown', 'straight arm lat pull', 'cable straight arm pulldown'],
    primary: ['lats'],
    secondary: ['back'],
    equipment: ['cables'],
    type: 'weight_reps',
  ...
  // ── User-requested rowing machine / cable rowing additions ──
  {
    name: 'Rowing Machine',
    slug: 'rowing_machine',
    aliases: ['erg', 'row erg', 'concept2', 'concept 2', 'ergometer', 'indoor rowing', 'standard row', 'rowing erg', 'rower'],
    primary: ['back', 'lats'],
  ...
  {
    name: 'Straight-Arm Cable Row',
    slug: 'straight_arm_cable_row',
    aliases: ['straight arm row', 'stiff arm row', 'cable straight arm row', 'scapular row', 'straight arm rows'],
    primary: ['back', 'traps'],
    secondary: ['shoulders'],
    equipment: ['cables'],
    type: 'weight_reps',
  },
  {
    ...
    aliases: ['one arm cable row', 'single arm row cable', 'alternating cable row', 'unilateral cable row', 'single arm seated row'],
    primary: ['lats', 'back'],
    secondary: ['biceps', 'core'],
    equipment: ['cables'],
    type: 'weight_reps',
  },
  // ── From website & common missing ──
  {
    name: 'High Row Machine',
    slug: 'high_row_machine',
    aliases: ['high row', 'overhand machine row', 'lat machine row', 'high cable row', 'iso lateral row'],
    primary: ['lats', 'back'],
    secondary: ['biceps'],
    equipment: ['machine'],
    type: 'weight_reps',
  },
  {
    ...
    slug: 'rear_delt_machine',
    aliases: ['rear delt machine', 'lever seated reverse fly', 'pec deck rear delt', 'reverse pec deck', 'rear delt fly machine', 'seated reverse fly machine', 'machine rear fly', 'rear delt reverse fly'],
  ...
  },
  {
    name: 'Back Extension',
    slug: 'back_extension',
    aliases: ['hyperextension', 'hyper extension', '45 degree back extension', 'glute ham raise back', 'lower back extension', 'back extensions'],
    primary: ['back'],
  ...
  },
  {
    ...
    slug: 'weighted_back_extension',
    aliases: ['weighted hyperextension', 'weighted hyper extension', 'loaded back extension', 'back extension with plate'],
    primary: ['back'],
    secondary: ['glutes', 'hamstrings'],
    equipment: ['machine'],
    type: 'weight_reps',
  },
  {
    name: 'Good Morning',
    slug: 'good_morning',
    aliases: ['good mornings', 'barbell good morning', 'bb good morning', 'seated good morning'],
  ...
  },
  {
    name: 'Superman',
    slug: 'superman',
    aliases: ['supermans', 'superman hold', 'prone back extension', 'floor back extension', 'superman exercise'],
    primary: ['back'],
    secondary: ['glutes'],
    equipment: ['bodyweight'],
    type: 'bodyweight_reps',
  },
  {
    name: 'Inverted Row',
    slug: 'inverted_row',
    aliases: ['australian pull up', 'body row', 'horizontal pull up', 'table row', 'trx row', 'bodyweight row'],
    primary: ['back'],
    secondary: ['biceps'],
    equipment: ['pullup_bar'],
    type: 'bodyweight_reps',
  },
  {
    name: 'Seal Row',
    slug: 'seal_row',
    aliases: ['prone row', 'seal rows', 'chest supported barbell row', 'lying row', 'prone barbell row'],
    primary: ['back'],
    secondary: ['biceps'],
    equipment: ['barbell'],
    type: 'weight_reps',
  },
  {
    name: 'Sumo Deadlift',
    slug: 'sumo_deadlift',
    aliases: ['sumo dl', 'wide stance deadlift', 'sumo dead lift', 'sumo stance deadlift'],
    primary: ['back', 'glutes', 'hamstrings'],
    secondary: ['traps', 'forearms'],
    equipment: ['barbell'],
    type: 'weight_reps',
  },
  {
    ...
    aliases: ['hex bar deadlift', 'hex deadlift', 'trap bar dl', 'hexagonal bar deadlift', 'hex bar dl', 'trap bar'],
    primary: ['back', 'glutes', 'hamstrings'],
    secondary: ['traps', 'forearms'],
    equipment: ['barbell'],
    type: 'weight_reps',
  },
  {
    ...
    slug: 'single_leg_rdl',
    aliases: ['single leg rdl', 'sl rdl', 'one leg rdl', 'single leg romanian deadlift', '1 leg rdl', 'single leg deadlift'],
    primary: ['hamstrings', 'glutes'],
    secondary: ['back'],
    equipment: ['dumbbells'],
    type: 'weight_reps',
  },
  {
    ...
    aliases: ['narrow grip pulldown', 'close grip pulldown', 'v bar pulldown', 'neutral grip lat pulldown', 'close grip lat pull'],
    primary: ['lats'],
    secondary: ['back', 'biceps'],
    equipment: ['cables'],
    type: 'weight_reps',
  },
  {
    ...
    aliases: ['one arm lat pulldown', 'single arm pulldown', 'unilateral lat pulldown', 'one arm pulldown'],
    primary: ['lats'],
    secondary: ['back', 'biceps'],
    equipment: ['cables'],
    type: 'weight_reps',
  },
  {
    name: 'Renegade Row',
    slug: 'renegade_row',
    aliases: ['renegade rows', 'plank row', 'dumbbell renegade row', 'push up row', 'db renegade row'],
    primary: ['back', 'core'],
  ...
  },
  {
    name: 'Yates Row',
    slug: 'yates_row',
    aliases: ['underhand barbell row', 'supinated barbell row', 'reverse grip row', 'reverse grip barbell row'],
    primary: ['back'],
    secondary: ['biceps'],
    equipment: ['barbell'],
    type: 'weight_reps',
  },
  {
    ...
    aliases: ['hammer grip pull up', 'parallel grip pull up', 'neutral pull up', 'parallel pull up'],
    primary: ['lats', 'back'],
    secondary: ['biceps'],
    equipment: ['pullup_bar'],
    type: 'bodyweight_reps',
  },
  {
    name: 'Muscle-Up',
    slug: 'muscle_up',
    aliases: ['muscle up', 'muscleup', 'bar muscle up', 'ring muscle up'],
    primary: ['lats', 'back'],
    secondary: ['triceps', 'shoulders'],
    equipment: ['pullup_bar'],
    type: 'bodyweight_reps',
  },
  {
    name: 'Jefferson Curl',
    slug: 'jefferson_curl',
    aliases: ['jefferson curls', 'weighted spinal flexion', 'jefferson curl deadlift'],
    primary: ['back'],
...
const SHOULDERS: ExerciseEntry[] = [
  ...
  },
  {
    ...
    slug: 'lateral_raise_machine',
    aliases: ['machine lateral raise', 'machine side raise', 'lateral raise machine', 'seated lateral raise machine', 'machine lat raise'],
    primary: ['shoulders'],
    secondary: [],
    equipment: ['machine'],
    type: 'weight_reps',
...
const BICEPS: ExerciseEntry[] = [
  {
    name: 'Barbell Curl',
    slug: 'barbell_curl',
    aliases: ['bb curl', 'straight bar curl', 'barbell bicep curl', 'bicep curl barbell', 'standing barbell curl', 'ez bar curl', 'ez curl', 'bicep curl (barbell)'],
    primary: ['biceps'],
    secondary: ['forearms'],
    equipment: ['barbell'],
    type: 'weight_reps',
  ...
  },
  {
    name: 'Hammer Curl',
    slug: 'hammer_curl',
    aliases: ['hammer curls', 'neutral grip curl', 'db hammer curl', 'dumbbell hammer curl', 'hammer bicep curl', 'cross body curl', 'hammer curl dumbbell', 'hammer curl (dumbbell)'],
  ...
  },
  {
    name: 'Cable Curl',
    slug: 'cable_curl',
    aliases: ['cable bicep curl', 'low cable curl', 'cable bar curl', 'rope curl', 'cable rope curl', 'cable curls', 'bicep curl cable', 'bicep curl (cable)'],
    primary: ['biceps'],
    secondary: [],
    equipment: ['cables'],
    type: 'weight_reps',
...
const TRICEPS: ExerciseEntry[] = [
  ...
  },
  {
    ...
    slug: 'seated_dip_machine',
    aliases: ['dip machine', 'machine dip', 'tricep dip machine', 'seated tricep dip', 'assisted dip machine', 'machine assisted dip'],
    primary: ['triceps'],
...
const LEGS: ExerciseEntry[] = [
  ...
  },
  {
    ...
    aliases: ['bodyweight squat', 'air squat', 'bw squat', 'body weight squat', 'free squat', 'no weight squat'],
    primary: ['quads', 'glutes'],
    secondary: ['hamstrings'],
    equipment: ['bodyweight'],
    type: 'bodyweight_reps',
  ...
  },
  {
    name: 'Leg Extension',
    slug: 'leg_extension',
    aliases: ['leg extensions', 'quad extension', 'machine leg extension', 'knee extension', 'quads machine', 'leg extension (machine)', 'leg extension machine'],
    primary: ['quads'],
    secondary: [],
    equipment: ['machine'],
    type: 'weight_reps',
  },
  {
    name: 'Leg Curl',
    slug: 'leg_curl',
    aliases: ['lying leg curl', 'seated leg curl', 'hamstring curl', 'machine leg curl', 'ham curl', 'leg curls', 'hamstring machine', 'seated leg curl (machine)', 'seated leg curl machine'],
    primary: ['hamstrings'],
    secondary: [],
    equipment: ['machine'],
    type: 'weight_reps',
  ...
  // Calves
  {
    ...
    aliases: ['calf raise', 'calf raises', 'standing calf', 'barbell calf raise', 'machine calf raise', 'smith calf raise', 'calves raise', 'standing calf raises (machine)', 'stanfing calf raises (machine)', 'standing calf raise machine'],
    primary: ['calves'],
    secondary: [],
    equipment: ['machine'],
    type: 'weight_reps',
...
const CORE: ExerciseEntry[] = [
  ...
  },
  {
    name: 'Bird Dog',
    slug: 'bird_dog',
    aliases: ['bird dogs', 'bird dog exercise', 'quadruped reach', 'opposite arm leg raise', 'dead bug variation'],
    primary: ['core'],
...
const FOREARMS: ExerciseEntry[] = [
  {
    name: 'Wrist Curl',
    slug: 'wrist_curl',
    aliases: ['wrist curls', 'barbell wrist curl', 'dumbbell wrist curl', 'forearm curl', 'wrist flexion', 'seated wrist curl', 'seated palms up wrist curl', 'seated palms up wrist curls', 'palms up wrist curl', 'palms up wrist curls'],
    primary: ['forearms'],
    secondary: [],
    equipment: ['barbell'],
    type: 'weight_reps',
  },
  {
    ...
    aliases: ['wrist extension', 'palms down wrist curl', 'reverse forearm curl', 'extensor curl', 'wrist extension curl'],
    primary: ['forearms'],
    secondary: [],
    equipment: ['barbell'],
    type: 'weight_reps',
  ...
  {
    name: 'Behind the Back Wrist Curl (Cable)',
    slug: 'behind_back_wrist_curl_cable',
    aliases: ['behind the back bicep wrist curl', 'behind back cable wrist curl', 'cable behind back wrist curl', 'reverse wrist curl cable', 'cable wrist curl behind back', 'behind back forearm curl'],
    primary: ['forearms'],
    secondary: ['biceps'],
    equipment: ['cables'],
    type: 'weight_reps',
...
const CARDIO: ExerciseEntry[] = [
  ...
  },
  {
    name: 'Treadmill',
    slug: 'treadmill',
    aliases: ['treadmill cardio', 'treadmill session', 'treadmill workout'],
    primary: ['cardio'],
    secondary: [],
    equipment: ['cardio_machine'],
    type: 'distance_duration',
  ...
  },
  {
    name: 'Elliptical',
    slug: 'elliptical',
    aliases: ['elliptical machine', 'cross trainer', 'elliptic', 'elliptical trainer', 'x-trainer', 'elliptical trainer machine'],
    primary: ['cardio'],
    secondary: [],
    equipment: ['cardio_machine'],
    type: 'distance_duration',
  ...
  },
  {
    name: 'Stretching',
    slug: 'stretching',
    aliases: ['stretch', 'stretches', 'mobility', 'mobility work', 'static stretching', 'dynamic stretching', 'cool down', 'cooldown', 'strecting', 'streching'],
    primary: ['full_body'],
    secondary: [],
    equipment: ['bodyweight'],
    type: 'duration',
