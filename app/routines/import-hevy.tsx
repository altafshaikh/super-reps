    ...
    >
      <View className="px-5 pt-16 pb-3 flex-row items-center gap-3">
        ...
        <View className="flex-1">
          <Text className="text-white font-bold text-lg">Import from Hevy</Text>
          <Text className="text-white/40 text-xs">CSV workout history → SuperReps</Text>
        </View>
      </View>
        ...
        >
          {importing ? (
            ...
            <>
              ...
              <Text className="text-white font-bold">Import to SuperReps</Text>
            </>
          )}
        </TouchableOpacity>
      </ScrollView>
